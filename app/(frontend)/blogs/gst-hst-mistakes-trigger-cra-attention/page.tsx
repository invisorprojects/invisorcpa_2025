...
const monthlyTrackingItems = [
    ...
    },
    {
        ...
        focus: ['Gross profit', 'Net profit', 'Profit margins'],
...
export const metadata: Metadata = {
    ...
    description:
        'A practical monthly financial tracking checklist for Canadian business owners covering revenue, cash flow, receivables, expenses, GST/HST, payroll, profit, and bank reconciliations.',
    keywords: [
        ...
        'small business net profit Canada',
    ],
    authors: [{ name: 'Invisor CPA' }],
    openGraph: {
        title: 'What Canadian Business Owners Should Track Monthly',
        description:
            'Track the financial numbers that shape profitability, cash flow, and CRA compliance each month.',
        url: 'https://www.invisorcpa.ca/blogs/gst-hst-mistakes-trigger-cra-attention',
        siteName: 'Invisor CPA',
        images: [
            {
                url: 'https://www.invisorcpa.ca/assets/banners/banner-13.webp',
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        title: 'What Canadian Business Owners Should Track Monthly',
        description:
            'A monthly checklist for revenue, cash flow, expenses, receivables, GST/HST, payroll, profit, and reconciliations.',
        images: ['https://www.invisorcpa.ca/assets/banners/banner-13.webp'],
        creator: '@invisorcpa',
    },
    alternates: {
        canonical:
            'https://www.invisorcpa.ca/blogs/gst-hst-mistakes-trigger-cra-attention',
    },
    robots: {
        index: true,
        follow: true,
            ...
            <section className="bg-[#F8FAFC] px-4 py-14 sm:px-8 md:px-12 lg:px-16 xl:px-24">
                <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-slate-100">
                        <Image
                            src="/assets/banners/banner-13.webp"
                            alt="Canadian business owner reviewing monthly financial reports"
                            width={960}
                            height={640}
                ...
                <div className="mx-auto max-w-6xl space-y-8">
                    <div className="max-w-3xl space-y-4">
                        <h2 className="text-primary text-3xl font-semibold">
                            The Monthly Review That Keeps Businesses in Control
                        </h2>
                        <p>
                    ...
                    <div className="grid gap-6 lg:grid-cols-2">
                        {monthlyTrackingItems.map((item, index) => (
                            <article
                                key={item.title}
